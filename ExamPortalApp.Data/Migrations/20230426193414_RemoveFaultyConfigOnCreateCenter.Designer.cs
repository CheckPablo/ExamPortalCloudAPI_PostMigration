...
namespace ExamPortalApp.Data.Migrations
{
    ...
    [Migration("20230426193414_RemoveFaultyConfigOnCreateCenter")]
    partial class RemoveFaultyConfigOnCreateCenter
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ExamPortalApp.Contracts.Data.Entities.Student", b =>
                {
                    ...
                    b.HasIndex(new[] { "GradeId" }, "IDXSector");
            ...
            modelBuilder.Entity("ExamPortalApp.Contracts.Data.Entities.StudentSubject", b =>
                {
                    ...
                    b.HasIndex("StudentId", "SubjectId")
                        .IsUnique()
                        .HasFilter("[StudentId] IS NOT NULL AND [SubjectId] IS NOT NULL");
            ...
            modelBuilder.Entity("ExamPortalApp.Contracts.Data.Entities.Student", b =>
                {
                    ...
                    b.HasOne("ExamPortalApp.Contracts.Data.Entities.Grade", "Grade")
                        .WithMany("Students")
